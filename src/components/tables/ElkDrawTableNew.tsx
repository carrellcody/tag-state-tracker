...
export function ElkDrawTableNew() {
  ...
  const [hunterClassManuallyChanged, setHunterClassManuallyChanged] = usePersistedState(
    "elkDrawNew_hunterClassManuallyChanged",
    false,
  );
      ...
      >
        ...
        <div className="space-y-2">
          ...
          >
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="A_R" id="elkNew-class-ar" />
              <Label htmlFor="elkNew-class-ar">Resident Adult</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="A_NR" id="elkNew-class-anr" />
              <Label htmlFor="elkNew-class-anr">Non-Resident Adult</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="Y_R" id="elkNew-class-yr" />
              <Label htmlFor="elkNew-class-yr">Resident Youth</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="Y_NR" id="elkNew-class-ynr" />
              <Label htmlFor="elkNew-class-ynr">Non-Resident Youth</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="L_U" id="elkNew-class-lu" />
              <Label htmlFor="elkNew-class-lu">Landowner Unrestricted</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="L_R" id="elkNew-class-lr" />
              <Label htmlFor="elkNew-class-lr">Landowner Restricted</Label>
            </div>
          </RadioGroup>
        </div>
            ...
            {[
              ...
              <div key={value} className="flex items-center space-x-2">
                <input
                  ...
                  className="rounded"
                />
                <Label htmlFor={`elkNew-sex-${value}`} className="cursor-pointer">
                  {label}
                </Label>
              </div>
            ))}
            ...
            {[
              ...
              <div key={value} className="flex items-center space-x-2">
                <input
                  ...
                  className="rounded"
                />
                <Label htmlFor={`elkNew-season-${value}`} className="cursor-pointer">
                  {label}
                </Label>
              </div>
            ))}
            ...
            {[
              ...
              <div key={value} className="flex items-center space-x-2">
                <input
                  ...
                  className="rounded"
                />
                <Label htmlFor={`elkNew-list-${value}`} className="cursor-pointer">
                  {label}
                </Label>
              </div>
            ))}
        ...
        <div className="space-y-2">
          ...
          <RadioGroup value={ploFilter} onValueChange={setPloFilter}>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="all" id="elkNew-plo-all" />
              <Label htmlFor="elkNew-plo-all">Show all tags</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="only" id="elkNew-plo-only" />
              <Label htmlFor="elkNew-plo-only">Show only PLO tags</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="none" id="elkNew-plo-none" />
              <Label htmlFor="elkNew-plo-none">Don't show PLO tags</Label>
            </div>
          </RadioGroup>
        </div>
        ...
        {hunterClass !== "A_NR" && hunterClass !== "Y_NR" && (
          <div className="space-y-2">
            ...
            <RadioGroup value={rfwFilter} onValueChange={setRfwFilter}>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="all" id="elkNew-rfw-all" />
                <Label htmlFor="elkNew-rfw-all">Show all tags</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="only" id="elkNew-rfw-only" />
                <Label htmlFor="elkNew-rfw-only">Show only RFW tags</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="none" id="elkNew-rfw-none" />
                <Label htmlFor="elkNew-rfw-none">Don't show RFW tags</Label>
              </div>
            </RadioGroup>
          </div>
        )}
        ...
        <Dialog open={showHybridHelp} onOpenChange={setShowHybridHelp}>
          <DialogContent className="max-w-lg">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              preference points. A small number of these tags are set aside to give those with greater than 5 points a
              chance at drawing.
            </p>
        ...
        <div className="space-y-2">
          ...
          <RadioGroup value={showNoApplicants} onValueChange={setShowNoApplicants}>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="yes" id="elkNew-no-apps-yes" />
              <Label htmlFor="elkNew-no-apps-yes">Yes</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="no" id="elkNew-no-apps-no" />
              <Label htmlFor="elkNew-no-apps-no">No</Label>
            </div>
          </RadioGroup>
        </div>
              ...
              {paginatedData.map((row: any, idx: number) => {
                ...
                return (
                  <Fragment key={idx}>
                    ...
                    {isExpanded && matchingSubtableRows.length > 0 && (
                      <tr>
                        <td
                          colSpan={visibleColumns.length + 1}
                          className="border border-border p-4 bg-primary-foreground text-popover-foreground"
                        >
