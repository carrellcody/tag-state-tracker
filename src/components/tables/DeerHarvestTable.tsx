...
export function DeerHarvestTable() {
  const { data, loading, error } = useCsvData(`/data/DeerHarvest24.csv?v=${CSV_VERSION}`);
  ...
  const baseColumns = ["UnitList", "Category", "Bucks", "Antlerless", "Total Harvest", "Total Hunters"];
