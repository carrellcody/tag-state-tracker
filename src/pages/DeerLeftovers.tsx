...
export default function DeerLeftovers() {
  return (
    <div className="container mx-auto px-4 py-20 min-h-[60vh] flex flex-col items-center justify-center text-center">
      <SEOHead
        title="Colorado Deer Secondary & Leftover Draws | TalloTags"
        description="Colorado deer secondary and leftover draw information — coming soon."
        canonicalPath="/Deer-Leftovers"
      />
