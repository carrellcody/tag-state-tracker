...
export default function ElkDraw() {
  ...
  return (
    <div className="container mx-auto pt-2 pb-10 h-[calc(100vh-8rem)]">
      <SEOHead 
        title="Colorado Elk Draw Odds 2025 | TalloTags"
        description="Colorado elk draw odds and preference point statistics for 2025. Analyze draw success rates by unit, season, and weapon type."
        canonicalPath="/elk"
      />
