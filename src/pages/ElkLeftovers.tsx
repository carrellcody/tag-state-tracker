...
export default function ElkLeftovers() {
  return (
    <div className="container mx-auto px-4 py-20 min-h-[60vh] flex flex-col items-center justify-center text-center">
      <SEOHead
        title="Colorado Elk Secondary & Leftover Draws | TalloTags"
        description="Colorado elk secondary and leftover draw information — coming soon."
        canonicalPath="/Elk-Leftovers"
      />
