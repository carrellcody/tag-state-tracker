    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="space-y-8">
        ...
        <Card className="shadow-medium">
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              <strong>What are preference points?</strong> Preference points can be accumulated each year you apply for a draw license but don't draw a tag (For example, if you apply for a tag that requires more preference points than you currently have). You can also simply specify that you would like to purchase a preference point. The application for preference points is due the same time that the draw application is due (Typically early April). The more points you have, the more tags become available to draw. For example, assum that there are 100 tags avaialble for a unit and 90 hunters apply who have 2 preference points, 20 hunters apply with 1 preference point, and 500 hunters apply with 0 preference points. In this scenario all 90 of the 2 preference point applicants will recieve a tag, meaning that there are 10 remaining tags.
              Therefore 10 of the 20 who applied with 1 point will recieve a tag, and this is determined by a random lottery-style draw. Finally, none of the 0 point applicants will recieve a tag. We can loop>
            <p>
              <strong>How do they work?</strong> Each preference point gives you an additional entry in the draw. If you have 5 preference points, your name goes in the hat 6 times (your initial application plus 5 bonus entries).
            </p>
            <p>
              <strong>Buying points:</strong> You can also purchase preference points without applying for a specific hunt. This allows you to build points for future years without competing in the current draw.
            </p>
          </CardContent>
        </Card>
